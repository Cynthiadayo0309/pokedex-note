  ...
  <div class="detail">
    <div class="detail-view card" v-if="show">
      ...
      <div v-if="pokemon" class="data card-body">
        ...
        <div class="property">
          <div class="left destaq">基礎経験値</div>
          <div class="right">{{ pokemon.base_experience }} XP</div>
        </div>

        <div class="property">
          <div class="left destaq">高さ</div>
          <div class="right">{{ pokemon.height / 10 }} m</div>
        </div>
        <div class="property">
          <div class="left destaq">重さ</div>
      ...
      <h2 v-else>見つかりませんでした。</h2>
      <button class="close" @click="closeDetail">閉じる</button>
    </div>
