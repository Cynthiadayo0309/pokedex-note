        ...
        <v-card>
          <v-card-text>
            <v-form>
               ...
               <v-text-field v-model="address.cha" label="性格"></v-text-field>
               <v-text-field v-model="address.atk" label="わざ"></v-text-field>
               <v-text-field v-model="address.item" label="アイテム"></v-text-field>
               <v-text-field v-model="address.abi" label="特性"></v-text-field>
               <v-text-field v-model="address.remarks" label="努力値・備考"></v-text-field>
